...
BOT_COMMANDS: List[BotCommand] = [
    ...
    BotCommand("syncfrom", "Resume after crash from last uploaded video"),
    ...
    BotCommand("setquality", "Video quality (best/4K/2K/1080/720/480/audio)"),
    BotCommand("caption", "Upload caption + Uploaded-by signature"),
    BotCommand("setname", "Signature name shown in captions"),
    BotCommand("setusername", "Signature Telegram username"),
    BotCommand("setparallel", "Download workers (1-5)"),
    BotCommand("setuploaders", "Upload workers (1-2)"),
    BotCommand("setqlimit", "Upload queue cap / download backpressure"),
